...
bool Projectile::init()
{
    ...
    m_pSprite->setColor(sf::Color::Magenta);
...
void Projectile::activate(sf::Vector2f a_position, float a_lifetime, float a_speed)
{
    reset();
...
void Projectile::setSpeed(float a_speed)
{
    if (speed < a_speed)
        speed = a_speed;
}